...
<div id="ctt_con" class="sub01_01">
    ...
    <div>
            ...
            <div id="controls">
                ...
                <div class="demo-controls-wrapper">
                    ...
                    <option value="" selected>
                      Select a test-stream from drop-down menu. Or enter custom URL below
                    </option>
                    </select>
                    ...
                    Enable streaming: <input id="enableStreaming" type="checkbox" checked />
                    </label>

                    <label class="innerControls" title="When a media error occurs, attempt to recover playback by calling `hls.recoverMediaError()`.">
                    Auto-recover media-errors: <input id="autoRecoverError" type="checkbox" checked />
                    </label>
                    ...
                    Stop on first stall: <input id="stopOnStall" type="checkbox" unchecked />
                    </label>

                    <label class="innerControls">
                    Dump transmuxed fMP4 data: <input id="dumpfMP4" type="checkbox" unchecked />
                    </label>

                    <label class="innerControls">
                    Metrics history (max limit, -1 is unlimited): <input id="limitMetrics" style="width: 8em" type="number" />
                    </label>
                    ...
                    <label class="innerControls">
                    Current player size: <span id="currentSize"></span>
                    </label>

                    <label class="innerControls">
                    Current video resolution: <span id="currentResolution"></span>
                    </label>
        ...
        <!-- 스트리밍 컨트롤 버튼 ( Playback | Timeline | Quality-levels | Audio-tracks | Real-time metrics | Buffer &amp; Statistics) -->
        <div class="center" style="text-align: center; display: none" id="toggleButtons">
            ...
            <button type="button" class="btn btn-sm demo-tab-btn" data-tab="audioTrackControlTab" onclick="toggleTabClick(this);">Audio-tracks</button>
            <button type="button" class="btn btn-sm demo-tab-btn" data-tab="metricsDisplayTab" onclick="toggleTabClick(this); showMetrics();">Real-time metrics</button>
        ...
        <div class="center demo-tab" id="playbackControlTab" style="display: none">
            ...
            <center>
                ...
                <p>
                    ...
                    <span>
                        <button type="button" class="btn btn-sm btn-info" title="video.playbackRate = text input" onclick="$('#video')[0].defaultPlaybackRate=$('#video')[0].playbackRate=$('#playback_rate').val();">
                            Playback rate
                        </button>
                    ...
                    <span>
                        <button type="button" class="btn btn-sm btn-info" title="video.currentTime = text input" onclick="$('#video')[0].currentTime=$('#seek_pos').val();">
                            Seek to
                        </button>
        ...
        <div class="center demo-tab" id="metricsDisplayTab" style="display: none">
            ...
            <div id="metricsButton">
                <button type="button" class="btn btn-xs btn-info" onclick="$('#metricsButtonWindow').toggle();$('#metricsButtonFixed').toggle();windowSliding=!windowSliding; refreshCanvas()">
